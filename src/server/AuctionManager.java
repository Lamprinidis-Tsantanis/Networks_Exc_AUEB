...
public class AuctionManager {
    ...
    public void startAuction() throws InterruptedException {
        try{
            ...
            currentAuctionThread = new AuctionManagerThread(dataStore,nextItem,sellerToken);
     ...
     *
     * @return {@code String[]} containing exactly two elements: the objectId at index 0 and the description at index 1 <br>
     *         {@code null} if there is currently no active auction running<br><br><br>
